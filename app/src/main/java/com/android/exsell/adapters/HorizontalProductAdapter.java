...
//        View currentItem;
        ...
        public MyViewHolder(View itemView){
            super(itemView);
            this.card = (LinearLayout) itemView.findViewById(R.id.layout_horizontal_card);
...
//            this.textViewTags = (TextView) itemView.findViewById(R.id.itemTags);
    ...
    @NonNull
    @Override
    public HorizontalProductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HorizontalProductAdapter.MyViewHolder holder, int position) {
